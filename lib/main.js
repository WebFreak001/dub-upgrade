...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let cacheDirs;
            if (doCache) {
                if (glob_1.default.sync("**/.dub").length > 0) {
            ...
            function storeCache() {
                return __awaiter(this, void 0, void 0, function* () {
                    if (cacheDirs) {
                        ...
                        cacheKey = `dub-package-cache-${process.platform}-${yield hashAll(dubArgs, cacheDirs, onlyStore)}`;
                        try {
...
function hashAll(data, dirs, buildCache) {
    for (let i = 0; i < dirs.length; i++) {
        const dir = dirs[i];
        data += "\n" + fs.readdirSync(dir).join("\n");
    }
    var files = glob_1.default.sync("**/dub.selections.json");
